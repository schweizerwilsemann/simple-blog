...
export default function Home() {
  ...
  return (
    <div>
      <div className="flex flex-col gap-6 p-28 px-3 nax-w-6xl mx-auto ">
      ...
      <div className="max-w-6xl mx-auto p-3 flex flex-col gap-8 py-7">
        {
          posts && posts.length > 0 && (
            <div className="flex flex-col gap-6">
              ...
              <Link to='/search' className='text-lg text-teal-600 dark:text-lime-400 hover:underline text-center'>
                View all posts
              </Link>
            </div>
          )
